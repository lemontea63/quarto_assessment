...
This represents a difference of 0.669mm (95%CI 0.381 to 0.956mm difference).
...
The Tukey analysis showed the mean value of beak depth (mm) differed between 1976 and 1978 by 0.669mm (95%CI 0.381 to 0.956mm).
As this 95% CI does not include 0 (which is what would be expected by the null hypothesis), this shows there is a significant difference between groups.
