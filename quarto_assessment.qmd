...
From the summary table for the finch_model, only 10.16% of variation in beak depth is explained by year (adjusted R-squared = 0.1016). This is surprising as it was expected that the year would play a large role in explaining variation in beak depth, and suggests there may be other factors influencing this. 
...
In conclusion, it has been shown that there is a difference in the mean beak depth of the medium ground finch between 1976 and 1978. In 1976, mean beak depth was 9.470mm but in 1978 the mean increased to 10.138mm. The results of the one-way ANOVA and Tukey test confirm that there is a statistically significant difference in mean beak depth between 1976 and 1978, coinciding with the 1977 drought. This therefore has shown that the 1977 drought caused a change in beak morphology in G. fortis in response to selection pressures exerted by drought and changing food availability, reflecting the restriction of food supply to large, tough seeds. 
