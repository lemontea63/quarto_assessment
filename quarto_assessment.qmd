...
As this 95% confidence intervals do not include 0 (which is what would be expected by the null hypothesis), this shows there is a significant difference between groups.
